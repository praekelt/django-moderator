...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClassifiedComment'
        db.create_table('moderator_classifiedcomment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comments.Comment'])),
            ('cls', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('moderator', ['ClassifiedComment'])

        # Adding model 'ClassifierState'
        db.create_table('moderator_classifierstate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('spam_count', self.gf('django.db.models.fields.IntegerField')()),
            ('ham_count', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('moderator', ['ClassifierState'])

        # Adding model 'Word'
        db.create_table('moderator_word', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('word', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('spam_count', self.gf('django.db.models.fields.IntegerField')()),
            ('ham_count', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('moderator', ['Word'])


    def backwards(self, orm):
        # Deleting model 'ClassifiedComment'
        db.delete_table('moderator_classifiedcomment')

        # Deleting model 'ClassifierState'
        db.delete_table('moderator_classifierstate')

        # Deleting model 'Word'
        db.delete_table('moderator_word')
