...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CommentReply.reply_comment'
        db.alter_column('moderator_commentreply', 'reply_comment_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['comments.Comment']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CommentReply.reply_comment'
        raise RuntimeError("Cannot reverse this migration. 'CommentReply.reply_comment' and its values cannot be restored.")
    ...
    models = {
        ...
        'moderator.commentreply': {
            ...
            'reply_comment': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'reply_comment_set'", 'null': 'True', 'to': "orm['comments.Comment']"}),
