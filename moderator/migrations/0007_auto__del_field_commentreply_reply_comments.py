...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field reply_comments on 'CommentReply'
    ...
    def backwards(self, orm):
        ...
        db.add_column('moderator_commentreply', 'reply_comments',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='reply_comments_set', null=True, to=orm['comments.Comment'], blank=True),
                      keep_default=False)

        # Removing M2M table for field reply_comments on 'CommentReply'
